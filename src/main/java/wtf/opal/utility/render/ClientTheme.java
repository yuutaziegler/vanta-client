...
public enum ClientTheme {
    TERENTX("TerentX", new Color(45, 191, 254), new Color(36, 153, 203)),
    ...
    private ClientTheme(String name, Color color, Color alternateColor) {
        this.name = name;
        this.colors = Pair.of((Object)color.getRGB(), (Object)alternateColor.getRGB());
    }
    ...
    public Pair<Integer, Integer> getColors() {
        if (this == CUSTOM) {
            return Pair.of((Object)((Integer)OverlayModule.primaryColorProperty.getValue()), (Object)((Integer)OverlayModule.secondaryColorProperty.getValue()));
        }
        if (this == RAINBOW) {
            return Pair.of((Object)ColorUtility.rainbow(20, 1, 1.0f, 1.0f), (Object)ColorUtility.rainbow(20, 40, 1.0f, 1.0f));
        }
        return this.colors;
    }
}
